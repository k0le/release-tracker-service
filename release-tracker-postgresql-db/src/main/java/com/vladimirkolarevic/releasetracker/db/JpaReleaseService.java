...
class JpaReleaseService implements ReleaseService {
    ...
    public Release save(Release release) {
        ...
        releaseJpaToSave.setCreatedAt(LocalDateTime.now());
        releaseJpaToSave.setLastUpdateAt(LocalDateTime.now());
    ...
    public List<Release> list(String name,
        ...
        return criteriaRepository.filter(name, description, status, releaseDate, createdAt, lastUpdateAt).stream()
    ...
    public Release update(Release release) {
        ...
        return releaseJpaRepository.findByUuid(release.id()).map(releaseJpaEntity -> {
            ...
            releaseJpaEntity.setLastUpdateAt(LocalDateTime.now());
